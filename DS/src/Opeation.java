...
public class Opeation {
  ...
  class FreePartition {
    public int freejobNumber; //空闲号
    public int freememorySize; //内存大小
    public int freestartAddress; //始地址
    public int freeendAddress; //结束地址

}
 class ProcessPartition {
    public int jobNumber; //作业号
    public int memorySize;  //内存大小
    public int startAddress;  //始地址
    public int endAddress;   //尾地址
}
